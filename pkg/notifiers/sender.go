...
func SendMessage(notifier *v3.Notifier, recipient string, msg *Message, dialer dialer.Dialer) error {
	...
	if notifier.Spec.WechatConfig != nil {
		...
		// PANDARIA
		return TestWechat(notifier.Spec.WechatConfig.Secret, notifier.Spec.WechatConfig.Agent, notifier.Spec.WechatConfig.Corp, notifier.Spec.WechatConfig.RecipientType, notifier.Spec.WechatConfig.APIURL, recipient, msg.Content, notifier.Spec.WechatConfig.HTTPClientConfig, dialer)
	}
...
// TestWechat PANDARIA
func TestWechat(secret, agent, corp, receiverType, apiURL, receiver, msg string, cfg *v3.HTTPClientConfig, dialer dialer.Dialer) error {
	if msg == "" {
