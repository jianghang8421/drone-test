...
var (
	...
	ProjectMonitoringServiceUI = newFeature("project-monitoring-service-ui", true) // PANDARIA
	ProjectPipelineServiceUI   = newFeature("project-pipeline-service-ui", true)   //PANDARIA
)
